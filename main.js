...
const renderPlanet = (planet, i) => {
    ...
    return `
        <div onclick="onPlanetRowClicked(${i})" class="table-row clickable">
            ...
            <div class="table-text half right"><button class="tooltip" onclick="onTransferIron(${i}, event)">${ planet.iron.toFixed(0) }<span class="tooltiptext">Click to transfer iron here from other planets. Cost: 5<span></button></div>
        </div>
    `
};
